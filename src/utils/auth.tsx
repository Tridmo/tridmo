...
export const AuthProvider = ({ children }) => {
  ...
  useEffect(() => {
    ...
    // if(typeof router.query.colors === 'object') {
    //   dispatch(setColorFilter({cnex: router.query.colors}));
    // } else if(router.query.colors) {
    //   dispatch(setColorFilter({cnex: [router.query.colors]}));
    // }

    // if(typeof router.query.styles === 'object') {
    //   dispatch(setStyleFilter({snex: router.query.styles}));
    // } else if(router.query.styles){
    //   dispatch(setStyleFilter({snex: [router.query.styles]}));
    // }

    // if(router.query.page) {
    //   dispatch(setPageFilter({page: router.query.page}));
    // }
