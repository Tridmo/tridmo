import { Box, Card, CardContent, Skeleton, SxProps } from "@mui/material";
...
export default function LinearCarousel({
  ...
  const doubledItems = items?.length
    ? [...items, ...items]
    : new Array(20).fill(1); // For smooth infinite scroll
      ...
      >
        ...
        <Box
          sx={{
            ...
            zIndex: 2,
            background:
              "linear-gradient(270deg, #FFFFFF 10%, rgba(255, 255, 255, 0) 100%)",
          }}
        />
