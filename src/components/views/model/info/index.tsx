...
export default function ModelInfo() {
  ...
  function DownloadHandler() {
    if (isAuthenticated) {
      ...
      instance
        .post(`models/download/${simpleModel?.id}`)
        .then((res) => {
    ...
    >
          ...
          >
            ...
            >
              ...
              >
                <Link
                  target="_blank"
                  href={`http://maps.google.com/?q=${simpleModel?.brand?.country}`}
                  ...
                  >
                    ...
                    <Box sx={{ marginLeft: "11px" }}>
                      ...
                      <SimpleTypography
                        ...
                        text={simpleModel?.brand?.country}
                      />
                    </Box>
                  </Buttons>
                </Link>
                      ...
                      (material: any, index: number) => (
                        <SimpleTypography
                          ...
                          text={`${material?.material?.name}${
                            index + 1 !== simpleModel?.materials.length
                              ? ", "
                              : ""
                          }`}
                          className="table__text"
      ...
      <Grid container sx={{ justifyContent: "space-between" }}>
        ...
        <Grid item md={5.8} xs={12}>
          <Buttons
            onClick={
              simpleModel?.availability != 2 ? DownloadHandler : () => {}
            }
            startIcon={isSubmitting}
            type="button"
            disabled={isSubmitting || simpleModel?.availability == 2}
            className={
              isSubmitting || simpleModel?.availability == 2
