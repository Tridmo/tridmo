    ...
    <footer style={{ marginTop: "auto" }}>
      <Box sx={{ width: "100%", flexGrow: 1, borderBottom: "1px solid #e0e0e0", paddingTop: "48px", background: "#fff" }}>
        <Grid container spacing={2} sx={{ maxWidth: "1200px", margin: "0 auto" }}>
          <Grid item xs={6} sx={{ padding: "0 !important", display: "flex", justifyContent: "flex-start" }}>
          ...
          <Grid item xs={6} sx={{ padding: "0 !important", display: "flex", justifyContent: "flex-end" }} >
            <Item sx={{ padding: "0" }}>
