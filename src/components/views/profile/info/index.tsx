    ...
    return (
      <Box sx={wrapperSx}>
        <Box sx={tableWrapperSx}>
          ...
          <TableContainer sx={tContainerSx} component={Paper}>
            <Table size="small" aria-label="a dense table">
              <TableBody sx={tbodySx}>
                ...
                >
                  <TableCell sx={tCellSx} component="th" scope="row">
                    <SimpleTypography text={"ФИО"} className="table__text" />
                  </TableCell>
                  <TableCell sx={tCellSx} align="right">
                    <SimpleTypography
                ...
                <TableRow sx={tRowSx}>
                  <TableCell sx={tCellSx} component="th" scope="row">
                    <SimpleTypography text={"Адрес"} className="table__text" />
                  </TableCell>
                  <TableCell sx={tCellSx} align="right">
                    {!!profileInfo?.address ? (
                      <SimpleTypography
                ...
                <TableRow sx={tRowSx}>
                  <TableCell sx={tCellSx} component="th" scope="row">
                    <SimpleTypography text={"Сайт"} className="table__text" />
                  </TableCell>
                  <TableCell sx={tCellSx} align="right">
                    {!!profileInfo?.portfolio_link ? (
                      <Link
                        target="_blank"
                        href={profileInfo?.portfolio_link || ""}
                      >
                        <SimpleTypography
                ...
                {profileInfo?.telegram && (
                  <TableRow sx={tRowSx}>
                    ...
                    <TableCell sx={tCellSx} align="right">
                      {props.of == "own" && !profileInfo?.telegram ? (
                        <AddButton />
                      ) : (
                        <OpenButton
                          href={getSocialLink(
